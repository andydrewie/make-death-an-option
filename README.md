...
![Red mineral handwriting on paper extending from an ImageWriter on Martian soil: Continue? Y/N.](assets/mdao-cover.png)
...
```mermaid
flowchart TD
    A[Make Death an Option] --> B[Evidence and open questions]
    A --> C[Universal Altruism]
    A --> D[Continuity Institution research]
    C --> E[Voluntary contribution and independent checking]
